...
const FrontPage = ({ onEnterDashboard }: FrontPageProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div ref={heroRef} className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-16">
        {/* Logo */}
        <div 
          ref={logoRef}
        ...
        >
          <span className="bg-gradient-to-r from-white via-[hsl(185,80%,70%)] to-[hsl(38,95%,65%)] bg-clip-text text-transparent">
            EAGLE CAR'S
          </span>
        </h1>
        ...
        <h2 
          ref={subtitleRef}
          className="text-xl md:text-2xl lg:text-3xl font-medium text-[hsl(185,80%,70%)] mb-3"
        >
        ...
        <div className="mt-16 flex items-center gap-4 text-white/30 text-sm">
          ...
          <span>Maritime Excellence Since 2024</span>
